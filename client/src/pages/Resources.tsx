...
const resourceCategories = [
  ...
  {
    type: "medical",
    title: "Medical and Behavioral Health",
    description: "Therapy clinics, suboxone providers, and behavioral health services",
    icon: Stethoscope,
    color: "text-primary",
    bgColor: "bg-primary/10",
    borderColor: "border-primary/40",
  },
  {
    type: "dental",
    title: "Dental Care",
    description: "Dental clinics and oral health support services",
    icon: Stethoscope,
    color: "text-primary",
    bgColor: "bg-primary/10",
    borderColor: "border-primary/40",
